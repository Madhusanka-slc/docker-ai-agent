...
# 3️⃣ Analogy
# Think of /app as a shared whiteboard:
# Container A writes on the whiteboard → Container B sees it instantly
# Container A and B are different people — their brains (processes, memory) are separate
# The whiteboard (mounted /app) is common, but everything else is independent


# docker compose run backend /bin/bash : override